  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <a
          href={links.tel}
          className="group inline-flex items-center gap-2 rounded-xl bg-brand-gradient px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm shadow-brand-900/10 transition-transform duration-200 hover:-translate-y-0.5 sm:px-4"
          aria-label={`Appeler le ${site.telephoneAffiche}`}
        >
          <PhoneIcon className="size-4 transition-transform duration-300 group-hover:rotate-12" />
